...
const getQuery = (req, res, next) => {
    ...
    let sql = `
        ...
        FROM (
            ...
            a2.audit_id, a2.audit_item_id, COALESCE(a2.audit_conformity, 1) AS audit_conformity, COALESCE(a2.audit_practical_order, 1) AS audit_practical_order, a2.audit_control_action, a2.audit_evidnece_compliance, a2.updatedAt as audit_updated_at, a2.user_id as audit_user_id
            FROM documents d
