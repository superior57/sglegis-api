module.exports = function (sequelize, DataTypes) {
    return sequelize.define('actionplan_items', {
        ...
        actionplan_id: { type: DataTypes.INTEGER, allowNull: false,  comment: 'The action plan which this item belong to' },
        activity: { type: DataTypes.STRING(5000), allowNull: false, comment: 'The activity description' },
