module.exports = function (sequelize, DataTypes) {
    return sequelize.define('document_scopes', {
        ...
        document_scope_description: { type: DataTypes.TEXT, allowNull: false, unique:true, comment: 'Scope is the scope of the legal requirement in relation to the territory' }
    }, {
